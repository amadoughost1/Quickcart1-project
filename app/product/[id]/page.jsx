...
const Product = () => {
    ...
    if (!productData || !productData.image || !Array.isArray(productData.image) || productData.image.length === 0) {
        return <Loading />;
    }
        ...
        {productData.price.toLocaleString()} FCFA
                            ...
                            <table className="table-auto border-collapse w-full max-w-72">
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-gray-800/50 ">Générique</td>
                                    </tr>
                                    <tr>
                                        <td className="text-gray-600 font-medium">Couleur</td>
                                        <td className="text-gray-800/50 ">Multiple</td>
                                    </tr>
                                    <tr>
                ...
                <div className="flex flex-col items-center">
                    <div className="flex flex-col items-center mb-4 mt-16">
                        <p className="text-3xl font-medium">En vedette <span className="font-medium text-orange-600">Produits</span></p>
